  ...
  return (
    <div className="space-y-16 py-4">
      ...
      <section className="grid lg:grid-cols-3 gap-6 pt-8">
        ...
        {/* NEW Column 3: Monetization (Merch & Ads) */}
        <div className="space-y-6">
          
          {/* Merch Widget */}
          <div className="panel-slf p-5 rounded-xl space-y-3 anime-glitch-hover border-jade-tech/30">
            ...
            <div className="bg-black/60 rounded border border-gray-800 p-3 text-center group cursor-pointer hover:border-jade-tech/50 transition-all">
              {/* Replace with actual merch design image from your POD service */}
              <div className="aspect-square bg-gray-900 rounded mb-3 flex items-center justify-center overflow-hidden">
                <img src="/images/Fantasy_map_of_Orr_region.jpeg" alt="Orr Map Mousepad" className="object-cover opacity-70 group-hover:opacity-100 transition-opacity" />
              </div>
          ...
          {/* Styled Ad Placement */}
          <div className="panel-slf p-4 rounded-xl space-y-2 anime-glitch-hover bg-black/80">
            <div className="flex justify-between items-center">
